...
module Rouge
  module Lexers
    class Goal < RegexLexer
      title 'Goal'
      desc "The Goal programming language (https://codeberg.org/anaseto/goal)"
      tag 'goal'
      filenames '*.goal'

      # https://anaseto.codeberg.page/goal-docs/chap-tutorial.html#verbs-adverbs
      def self.token_map
        @token_map ||= {
